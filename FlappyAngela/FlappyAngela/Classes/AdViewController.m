...
- (void)initializeBanner {
    ...
    _bannerView = [[ADBannerView alloc]initWithFrame:CGRectMake(0.0, self.view.frame.size.height, self.view.frame.size.width, 50.0)];
        //此Banner所能支援的类型
        ...
        //设定偏位移量
        _bannerView.frame = CGRectOffset(_bannerView.frame, 0, 30);
...
- (void)bannerViewAnimation {
    ...
    if (_bannerView.userInteractionEnabled) {
        ...
        adBannerViewFrame.origin.y = contentFrame.size.height/8;
